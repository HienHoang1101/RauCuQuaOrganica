        ...
        <div id="page-wrapper">
            <div class="header">
                <div class="page-header">
                    ...
                    <p>Dưới đây là danh sách các tin tức đã được thêm vào:</p>

                    <!-- /. XỬ LÝ CODE PHP  -->
                    <?php
                    require_once('../../dao/tin-tuc.php');

                    $items = tin_tuc_select_all();
                    ?>
                    <!-- /. CONTENT  -->
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $ngay_dang ?></td>
                                    <td>
                                        <a href="tin-tuc-update.php?ma_tt=<?= $ma_tt ?>"><button class="btn btn-primary">Sửa</button></a>
                                        <a onclick="return confirm('Bạn có chắc chắn muốn xóa ?')" href="tin-tuc-delete.php?ma_tt=<?= $ma_tt ?>"><button class="btn btn-danger">Xóa</button></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
                    <a href="../../content/tin-tuc/tin-tuc-new.php"><button class="btn btn-danger">Thêm mới</button></a>
                </div>
            </div>
        </div>
