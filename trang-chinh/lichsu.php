...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-4" style="background-color: #17594A;text-align: center"></div>
            <div class="col-md-4" style="background-color: #17594A;text-align: center">
                            ...
                            <table class="table table-hover">
                                ...
                                <?php foreach($items as $item){ 
                                  ...
                                  <tr>
                                    ...
                                    <td><a href="lichsu-chitiet.php?ma_hd=<?=$ma_hd?>&ma_kh=<?=$ma_kh?>"><button class="btn btn-success">Chi tiết</button></a></td>
                                  </tr>
                                <?php } ?>
                                </tbody>
                              </table>
