...
">
    ...
    <div class="container" style="margin-top: 80px;">
        ...
        <?php
                    require_once ('../../RauCuQuaOrganica/admin/dao/hang-hoa.php');
                        extract($_REQUEST);
            ...
            <div class="col-md-4" style="padding-left: 0px">
                <div class="spchitiet">
                    <img src="../../RauCuQuaOrganica/css/admin/images/products/<?=$hinh?>" alt="" style="width:100%;">
                </div>
            </div>
            <div class="col-md-5">
                    ...
                    <ul>
                        ...
                        <!-- MÃ CODE PHP CHECK ĐĂNG NHẬP ĐỂ MUA HÀNG -->
                            <?php
                                if(!isset($_SESSION['user'])){
                            ?>
                            <a href="../../RauCuQuaOrganica/tai-khoan/dang-nhap.php"><button style="margin-top:-5px;" class="btn btn-dark">ĐĂNG NHẬP ĐỂ MUA HÀNG</button></a>
                                <?php }else{ ?>
            ...
            <tr>
                <th colspan="3">THÔNG TIN GIAO HÀNG</th>
            </tr>
            <tr>
                <td><strong>Thời gian giao hàng<strong></td>
                <td>1. Nội thành TP. Hồ Chí Minh: <br>
                Thời gian: 4 - 6 tiếng<br>
                2. Các khu vực khác: <br>
                Thời gian: 1 - 3 ngày
                </td>
            </tr>
            <tr>
                <td><strong>Chính sách đổi trả<strong></td>
                <td>Áp dụng cho toàn bộ đơn hàng của Quý Khách tại <strong>Organica</strong>.<br>
                Chúng tôi luôn trân trọng sự tin tưởng và ủng hộ của quý khách hàng khi trải nghiệm mua hàng tại <strong>Organica</strong>.<br>Do đó chúng tôi luôn cố gắng hoàn thiện dịch vụ tốt nhất để phục vụ mọi nhu cầu mua sắm của quý khách.
                </td>
            </tr>
            <tr>
                <td><strong>Chính khách sỉ<strong></td>
                <td>Quý khách có nhu cầu mua sỉ, vui lòng liên hệ:
                <br>- Phòng kinh doanh: 1900 63 64 62 
                <br>- Email: info@organica.com.vn
                </td>
            </tr>
        </table>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12" style="padding-left: 0px;">
                ...
                <div class="owl-carousel owl-theme ">
                    ...
                    ?>
                    <div class="item">
                       <a href="chi-tiet-sp.php?ma_hh=<?=$ma_hh?>"><img style="width: 200px" src="../../RauCuQuaOrganica/css/admin/images/products/<?=$hinh?>" alt="ds"><span class='cung-loai'><?=$ten_loai?></span></a>
                    </div>
                        <?php } ?>
                </div>
            </div>
