...
<html lang="en">
    ...
    <body>
        <?php
        require_once("../../RauCuQuaOrganica/admin/dao/pdo.php");
        ...
        <div class="container">
            ...
            <div class="table-responsive">
                ...
                <div class="form-group">
                    ...
                    <label>
                        ...
                        if ($secureHash == $vnp_SecureHash) {
                            if ($_GET['vnp_ResponseCode'] == '00') {
                                ...
                                $conn = new mysqli("localhost","root","","RauCuQuaOrganica");
                                $taikhoan = '';
                    ...
                    <br>
                    <a href="https://localhost/RauCuQuaOrganica/trang-chinh/index.php">
