...
">
    ...
    <?php
        require_once ('../../RauCuQuaOrganica/admin/dao/khach-hang.php');
    ...
    <div class="container" style="margin-top: 80px;">
        ...
        <input type="text" class="form-control" id="" name="ma_kh" value="<?=$ma_kh?>" hidden>
            ...
            <thead>
                ...
                <tr>
                    <td colspan="2"><i>Quý khách vui lòng kiểm tra lại thông tin giao hàng và thông tin đơn hàng để tiến hành đặt hàng. Quý khách có thể tra cứu tình trạng đơn hàng tại Organica. Chúc quý khách ngày mới tốt lành!</i></td>
                </tr>
                <tr>
            ...
            <?php
                require_once ('../../RauCuQuaOrganica/admin/dao/hoa-don.php');
            ...
            <?php
                ...
                try {
                    ...
                    header("Location: http://localhost/RauCuQuaOrganica/vnpay_php/index.php?order_id=" .$ma_hd. "&total=".$total);
                    exit();
                } 
