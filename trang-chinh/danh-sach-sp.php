...
">
                    ...
                    <!-- CODE PHP DANH MỤC -->
                    <?php
                        require_once ('../../RauCuQuaOrganica/admin/dao/loai-hang.php');
                        extract($_REQUEST);
                    ...
                    <div class="row" style="margin-top: 35px;margin-left: 0px;">
                        ...
                        ?>
                            ...
                            <li class="list-group-item">
                                <div class="row">
                                    <div class="col-sm-4"><a href="chi-tiet-sp.php?ma_hh=<?=$ma_hh?>&ma_loai=<?=$ma_loai?>"><img style="width:80px;" src="../../RauCuQuaOrganica/css/admin/images/products/<?=$hinh?>" alt=""></a></div>
            ...
            ?>
                ...
                <a href="chi-tiet-sp.php?ma_hh=<?=$ma_hh?>"><span class="chi-tiet">CHI TIẾT</span></a>
                    ...
                    <a href="chi-tiet-sp.php?ma_hh=<?=$ma_hh?>"><img  src="../../RauCuQuaOrganica/css/admin/images/products/<?=$hinh?>" alt=""><span class='hang-moi'>Sản phẩm mới</span></a>
                    <div class="glow-wrap">
    <i class="glow"></i>
  </div>
                    <div class="text">
        ...
        <div class="row">
            ...
            <div class="col-md-12" style="padding-left: 0px;">
                ...
                <div class="owl-carousel owl-theme ">
                    ...
                    ?>
                    <div class="item">
                        <a href="chi-tiet-sp.php?ma_hh=<?=$ma_hh?>"><img style="width: 200px" src="../../RauCuQuaOrganica/css/admin/images/products/<?=$hinh?>" alt="ds"><span class='noi-bat'>HOT</span></a>
                    </div>
                        <?php } ?>
                </div>
            </div>
