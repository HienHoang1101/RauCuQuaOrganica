        ...
        <div id="page-wrapper">
            <div class="header">
                <div class="page-header">
                    ...
                    <p>Điền đầy đủ thông tin để thêm tin tức mới :</p>
                    ...
                    if (array_key_exists("btn_insert", $_REQUEST)) {
                        tin_tuc_insert($tieu_de, $noi_dung, $ngay_dang);
                        unset($ma_tt, $tieu_de, $noi_dung, $ngay_dang);
                    }
                    ?>
                    <!-- /. CONTENT  -->
                    <form action="" method="POST">
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Auto number ..." name="ma_tt" readonly />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="5" placeholder="Nhập nội dung ..." name="noi_dung"></textarea>
                        </div>
                        <div class="form-group">
